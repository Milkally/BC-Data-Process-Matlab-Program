function[aaa]=MergeTempYear(struct_Vamos,q)
...
for j=1:diffYear
   ...
   switch q
       case{1}
        %mkdir ('D:\BC_Figures\data\BC_4_merge\Year\Fulltime\',Yearstr)
        mkdir ('D:\BC_Figures\data\BC_4_merge\Temp_Year\Fulltime\',Yearstr)
        TempYearPath=strcat('D:\BC_Figures\data\BC_4_merge\Temp_Year\Fulltime\',Yearstr);
       case{2}
        %mkdir ('D:\BC_Figures\data\BC_4_merge\Year\RMmissing\',Yearstr)
        mkdir ('D:\BC_Figures\data\BC_4_merge\Temp_Year\RMmissing\',Yearstr)
        TempYearPath=strcat('D:\BC_Figures\data\BC_4_merge\Temp_Year\RMmissing\',Yearstr);
   end
   for k=1:inThisYear
...
mkdir D:\BC_Figures\data\BC_4_merge\Year\RMmissing
mkdir D:\BC_Figures\data\BC_4_merge\Year\Fulltime
switch q
    case{1}
    folderstr=strcat('D:\BC_Figures\data\BC_4_merge\Temp_Year\Fulltime\',Yearstr);
        goalexcel=strcat('D:\BC_Figures\data\BC_4_merge\Year\Fulltime\',Yearstr,'.xlsx');
    case{2}
    folderstr=strcat('D:\BC_Figures\data\BC_4_merge\Temp_Year\RMmissing\',Yearstr);
        goalexcel=strcat('D:\BC_Figures\data\BC_4_merge\Year\RMmissing\',Yearstr,'.xlsx');
end
