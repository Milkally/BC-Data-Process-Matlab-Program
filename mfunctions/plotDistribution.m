function [picwhether]=plotDistribution(BC6,Datastr,Filepath)
picwhether=0;
...
figure(1) %频数直方图,宽度5
h1 = histogram(BC6);
set(h1,'FaceColor',[0 191 255]/255,'LineWidth',2,'EdgeColor','w','Binwidth',2.5);
title(titlestr,'Fontname','times new Roman');
ax=gca;
ax.XLim=[0 35];
xlabel('BC Concentration[μg/m^{3}]','Fontname','times new Roman');
ylabel('BC Concentration Count');
legend('BC Concentration Count','Location','NorthEast');
%存储图片
...
figure(2) %频数直方图，宽度1
h2 = histogram(BC6);
set(h2,'FaceColor',[0 191 255]/255,'LineWidth',0.8,'EdgeColor','w','Binwidth',1);
title(titlestr,'Fontname','times new Roman');
ax=gca;
ax.XLim=[0 35];
xlabel('BC Concentration[ug/m^{3}]','Fontname','times new Roman');
ylabel('Count');
legend('BC Concentration Count','Location','NorthEast');
%存储图片
...
set(h3,'FaceColor',[0.98039 0.50196 0.44706],'LineWidth',0.5,'EdgeColor','w','Binwidth',1);
title(titlestr,'Fontname','times new Roman');
ax=gca;
ax.XLim=[0 35];
ax.TickDir='out';
xlabel('BC Concentration[ug/m^{3}]','Fontname','times new Roman');
ylabel('Frequency');
legend('BC Frequency','Location','NorthEast');
%存储图片
...
set(h4,'FaceColor',[65 105 225]/255,'LineWidth',1.5,'EdgeColor','w','Binwidth',1);
...
ll=legend('BC Frequency','BC Empirical CDF','Location','NorthEast');
%保存图片
...
yyaxis left
h4 = histogram(BC6,10,'Normalization','probability');
set(h4,'FaceColor',[65 105 225]/255,'LineWidth',1.5,'EdgeColor','w','Binwidth',2.5);
ax=gca;ylabel('Frequency');
hold on
yyaxis right  % 用右边的y轴展示
cdfplot(BC6);
...
xlabel('BC Concentration[ug/m^{3}]','Fontname','times new Roman');
ylabel('Empirical CDF');
ll=legend('BC Frequency','BC ECDF','Location','NorthEast');
%存储图片
...
h6 = histogram(BC6,10,'Normalization','probability');
set(h6,'FaceColor',[0.98039 0.50196 0.44706],'LineWidth',2,'EdgeColor','w','Binwidth',5);
title(titlestr,'Fontname','times new Roman');
ax=gca;
ax.XLim=[0 35];
ax.TickDir='out';
xlabel('BC Concentration[ug/m^{3}]','Fontname','times new Roman');
ylabel('f(x)');
ll=legend('BC Frequency','Location','NorthEast');
%存储图片
...
set(h7,'FaceColor',[255 193 193]/255,'LineWidth',1,'EdgeColor','w','BarWidth',1);%橙红色
h7.FaceAlpha=0.9;%黄
ax=gca;
ylabel('Frequency');
ax.XLim=[0 35];
